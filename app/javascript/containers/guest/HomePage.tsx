  ...
  <div className={styles.container}>
    <div className={styles.hero}>
      ...
      <div className={styles.secondColumn}>
        <img className={styles.firstImage} src={yellowDotRightShield} alt="leftIcon" />
        <img className={styles.secondImage} src={zPicture} alt="customerSupport" />
        <img className={styles.thirdImage} src={blueDotLeftBars} alt="rightIcon" />
      </div>
    </div>
  </div>
);
