class PagesController < ApplicationController
  ...
  def dashboard_data
    ...
    @dashboard_data = {
      ...
      open: open.count, hold: hold.count, close: close.count, assigned: assigned.count, unresolved_count: unresolved_count.count, replies: replies.count, new_tickets: new_tickets_count, tickets_per_day: tickets_per_day }
  end
